...
(function() {
    ...
    function resizeRoot() {
        if (!document.getElementById("s_fixed")) {
            var f = document.createElement("div");
            f.style = "position:fixed;width:100%;height:100%;left:0;top:0";
    ...
    if (!document.addEventListener) { resizeRoot(); return; };
    var docEl = document.documentElement,
        resizeEvt = 'orientationchange' in window ? 'orientationchange' : 'resize';

    window.addEventListener(resizeEvt, resizeRoot, false);
    document.addEventListener('DOMContentLoaded', resizeRoot, false);
